/*global nui*/
nui.add("accordion", function(nui) {
    ...
    var dom     = nui.dom,
        ...
        // Constants
        TAB_CLASS      = "nui-accordion-tab",
        TABS_CLASS      = "nui-accordion",
        PANELS_CLASS    = "nui-accordion-content",
        SELECTED_CLASS  = "nui-selected",

        TAB_QUERY      = util.format(".%s", TAB_CLASS),
    ...
    function getTabsAndPanels(element) {
        var tabs   = dom.selectAll(TAB_QUERY, element),
            panels = dom.selectAll(PANELS_QUERY, element);
    ...
    function changeTab(element, index) {
        ...
        aria.focusable(tabs[index], true);
        ...
        initType: function(element) {
           ...
           //ui-accordion ui-widget ui-helper-reset
            ...
            util.forEach(tabs, function(item, i) {
                ...
                aria.setRole(item, "accordion-tab");
